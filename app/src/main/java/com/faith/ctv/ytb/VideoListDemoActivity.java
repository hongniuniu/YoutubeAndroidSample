...
public final class VideoListDemoActivity extends Activity implements OnFullscreenListener {
  ...
  public static final class VideoFragment extends YouTubePlayerFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
      super.onCreate(savedInstanceState);
      Log.d("VideoListDemoActivity","YouTubePlayerFragment-->onCreate...");
    ...
    public void onPause() {
      super.onPause();
      Log.d("VideoListDemoActivity","YouTubePlayerFragment-->onPause...");
    }

    @Override
    public void onStop() {
      super.onStop();
      Log.d("VideoListDemoActivity","YouTubePlayerFragment-->onStop...");
    }
